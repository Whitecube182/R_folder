...
Since the population diffesr quite a bit a better visualzation would be the following:
...
Again, we see that Egypts GDP is much smaller compared to China. There for we can visualize it like this instead:
